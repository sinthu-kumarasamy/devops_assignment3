...
import Miracle from '../pages/Miracle.js';
import SongBM from '../pages/SongBM.js';
import Song3 from '../pages/Song3.js';
      ...
      <Router history={history} title={title} >
        ...
        >
          ...
          <List>
            ...
            {/* Charts menu item*/}
            <ListItem button component={Link} to="/song1" onClick={onItemClick('Miracle')}>
              <ListItemIcon>
                <MusicIcon />
              </ListItemIcon>
            ...
            {/* Deposits menu item*/}
            <ListItem button component={Link} to="/song2" onClick={onItemClick('SongBM')}>
              <ListItemIcon>
                <MusicIcon />
              </ListItemIcon>
              <ListItemText primary="SongBM" />
              { title === 'SongBM' && 
                <ListItemIcon>
                  <IconButton onClick={handleDrawerCollapsed}>
                    <ChevronLeftIcon />
            ...
            {/* Orders menu item */}
            <ListItem button component={Link} to="/song3" onClick={onItemClick('Bella Ciao')}>
              <ListItemIcon>
                <MusicIcon />
              </ListItemIcon>
              <ListItemText primary="Bella Ciao" />
              { title === 'Bella Ciao' && 
                <ListItemIcon>
        ...
        <main className={classes.content}>
          ...
          <Route path="/song1" component={Miracle} />
          <Route path="/song2" component={SongBM} />
