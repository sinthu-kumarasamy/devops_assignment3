...
import Image from "../images/songBM.jpg";
const style = { marginLeft: 1, };

class SongBM extends Component {
  constructor(props) {
    super(props);
    this.state = {
        songData: '',
  ...
  getLyrics() {
    fetch('http://localhost:5000/Song/SongBM',{
      headers: {
  ...
  return (
    <Paper>
    <h1>Just the Way you are Lyrics</h1>
      <div class="main">
